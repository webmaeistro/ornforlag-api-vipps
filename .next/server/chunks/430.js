...
/* harmony export */   "default": () => (/* binding */ VippsWrapper)
/* harmony export */ });
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    async function load() {
      ...
      const {
        ...
        crystallizeOrderId,
        checkoutLink
      } = ((_response$data = response.data) === null || _response$data === void 0 ? void 0 : (_response$data$paymen = _response$data.paymentProviders) === null || _response$data$paymen === void 0 ? void 0 : (_response$data$paymen2 = _response$data$paymen.vipps) === null || _response$data$paymen2 === void 0 ? void 0 : _response$data$paymen2.initiatePayment) || {};
